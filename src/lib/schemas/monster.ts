...
// │   alignment? : enum("lawful good"|"neutral good"|"chaotic good"|"lawful neutral"|"neutral"|"chaotic neutral"|"lawful evil"|"neutral evil"|"chaotic evil"|"unaligned"|"any alignment"|"any good alignment"|"any evil alignment"|"any non-good alignment"|"any non-lawful alignment"|"any chaotic alignment"|"any lawful alignment") = "neutral"  — engl. Gesinnung, z.B. "chaotic evil"
// │   ac?:
// │     value : int
// │     note? : string = ""
// │   hp?:
// │     average : int
// │     formula? : string = ""  — z.B. "2d8+2"
// │   speed? : string = ""  — z.B. "9 m", ggf. mit Flug/Schwimmen
// │   stats?:
// │     str : int
// │     dex : int
// │     con : int
...
// │     wis : int
// │     cha : int
// │   saving_throws? : {…} = {}  — z.B. {"con":"+4"}
// │   skills? : {…} = {}  — z.B. {"Heimlichkeit":"+6"}
// │   damage_resistances? : string[] = []
// │   damage_immunities? : string[] = []
// │   condition_immunities? : string[] = []
// │   senses? : string = ""
// │   languages? : string = ""
// │   cr? : string = "1/4"  — Herausforderungsgrad, z.B. "1/4", "5"
// │   xp? : int = 0
// │   traits?[]:
// │     name : string
// │     description : string
...
// │       type : string  — Schadensart (deutsch), z.B. "Feuer"
// │   actions?[]:
// │     name : string
// │     description : string
// │     attack_bonus? : int
